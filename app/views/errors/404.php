<?php
/**
 * R-DEIP 404 Error Page — COMPLETELY SELF-CONTAINED
...
:root{--c-primary:#00693E;--c-primary-light:#00A651;--c-accent:#E5A100;--c-blue:#1B3A6B;--bg:#0B1120;--surface:rgba(255,255,255,0.04);--border:rgba(255,255,255,0.08);--text:#F1F5F9;--muted:#94A3B8;--dim:#64748B;--font:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;--mono:'SF Mono','Fira Code',monospace}
...
.bg::before{content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(ellipse 600px 600px at 25% 35%,rgba(0,166,81,0.35),transparent),radial-gradient(ellipse 500px 500px at 75% 65%,rgba(229,161,0,0.25),transparent),radial-gradient(ellipse 400px 400px at 50% 50%,rgba(27,58,107,0.2),transparent);animation:drift 20s ease-in-out infinite alternate}
...
.orb-1{width:300px;height:300px;top:-80px;right:-60px;background:var(--c-primary-light);animation-delay:0s}
...
.icon-ring{position:absolute;inset:0;border-radius:50%;border:2px solid transparent;border-top-color:var(--c-primary-light);border-right-color:rgba(0,166,81,0.3);animation:spin 8s linear infinite}
.icon-ring-inner{position:absolute;inset:12px;border-radius:50%;border:1.5px solid transparent;border-bottom-color:var(--c-primary-light);border-left-color:rgba(0,166,81,0.15);animation:spin 12s linear infinite reverse}
@keyframes spin{to{transform:rotate(360deg)}}
.icon-bg{position:absolute;inset:20px;border-radius:50%;background:var(--c-primary);opacity:.08;box-shadow:0 0 60px rgba(0,105,62,0.35)}
.icon-svg{position:relative;z-index:2;width:56px;height:56px}
.error-code{font-size:7rem;font-weight:800;line-height:1;letter-spacing:-.04em;margin-bottom:.25rem;background-image:linear-gradient(135deg,#00A651,#34D399,#6EE7B7,#34D399,#00A651);background-size:200% 100%;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;animation:shimmer 3s ease-in-out infinite}
...
<div class="content">
    <div class="icon-wrap">
        ...
        <svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="#34D399" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/><path d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z"/></svg>
    </div>
